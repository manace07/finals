...
<div class="container-fluid bg-light">
    <div class="col">
        ...
        <form class="fs-6" action="{{ route('welcome.validate_login') }}" method="POST">
            @csrf
            ...
            <div class="form-group text-center fs-5"><input type="submit" value="LOGIN"></div>
            <div><a class="reg nav-link text-center fs-5" onclick="window.location.href='{{route('registration')}}'">Register</a></div>
</div>
        </form>
